...
% =============================================================================
% Slide: Helpful Resources
% =============================================================================
\begin{frame}{Helpful Tools and Resources}
    \begin{itemize}
        \item \textbf{Overleaf Documentation}: \url{https://www.overleaf.com/learn} — excellent for learning Overleaf itself and LaTeX in general, even if you're working locally.
        \item \textbf{Detexify}: \url{http://detexify.kirelabs.org} — draw a symbol, and it tells you the LaTeX command for it.
        \item \textbf{LaTeX Templates}: \url{https://www.latextemplates.com} — get started quickly with professional document layouts.
        \item \texttt{minted}, \texttt{siunitx}, \texttt{amsmath}, \texttt{circuitikz} — useful packages for syntax highlighting, units, math, and circuit diagrams.
        \item \textbf{CTAN (Comprehensive TeX Archive Network)}: \url{https://ctan.org} — the main repository for all LaTeX packages. Especially useful when developing locally without Overleaf.
    \end{itemize}
\end{frame}    
